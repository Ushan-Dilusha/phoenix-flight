...
<nav class="navbar navbar-expand-lg navbar-dark p-md-3" style="background-color:#150E56">
    <a class="navbar-brand" href="index.jsp"><img src="./images/logo.svg" height="34"></a>
	  ...
	  <div class="collapse navbar-collapse" id="navbarNav">
		    ...
		    <ul class="navbar-nav">
		      <li class="nav-item">
			        	<a class="nav-link text-white" href="user_dashboard.jsp">Home</a>
			      </li>
			      <li class="nav-item">
			        	<a class="nav-link text-white" href="flight_details.jsp">Flight Details</a>
			      </li>
			      <li class="nav-item">
			        	<a class="nav-link text-white" href="about_us.jsp">About Us</a>
			      </li>
