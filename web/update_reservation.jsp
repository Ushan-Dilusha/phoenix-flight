	...
	<%@include file="user_header.jsp" %>
		...
		<section style="background-color: #eee;opacity: 0.85">
		  ...
		  <%
				...
				ticket = ticketDao.getTicketRecord(ticket);
		          ...
		          <div class="card-body">
		            <div class="d-flex justify-content-between align-items-center pb-2 mb-1">
		              <form action="UpdateTicket" method="post" style="width: 23rem;">
			              ...
			              <input type="text" name="email" class="form-control form-control-lg" value="<%=session.getAttribute("email")%>" hidden>
							<input type="text" name="id" value="<%=flight.getId() %>" hidden>
							<input type="text" name="tid" value="<%=ticket.getId() %>" hidden>
			            </div>
		              	<div class="pt-1 mb-4">
			            	<input class="btn btn-outline-primary" type="submit" name="updateTicket" value="Update Ticket">
